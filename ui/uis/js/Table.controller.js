...
//   }
	 ...
	 onTBPress: function(oEvent,oController){
		 ...
		 if (oEvent.getSource().getId()=="btnExcel"){
			$.download('/sap/hana/democontent/epmNext/services/poWorklistQuery.xsjs','cmd=Excel','GET' );
			 return;
		 }
	...
	//Table Row Select Event Handler
	 ...
	 deleteConfirm: function(bResult,oController,poId){
		 if(bResult){ 
			 var aUrl = '/sap/hana/democontent/epmNext/services/poWorklistUpdate.xsjs?cmd=delete'+'&PurchaseOrderId='+escape(poId);
			 jQuery.ajax({
			       url: aUrl,
			       method: 'GET',
			       dataType: 'text',
	 ...
	 approvalConfirm: function(bResult,oController,poId,action){
		 if(bResult){ 
			 var aUrl = '/sap/hana/democontent/epmNext/services/poWorklistUpdate.xsjs?cmd=approval'+'&PurchaseOrderId='+escape(poId)+'&Action='+escape(action);
			 jQuery.ajax({
			       url: aUrl,
			       method: 'GET',
			       dataType: 'text',
