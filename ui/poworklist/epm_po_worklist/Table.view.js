sap.ui.jsview("epm_po_worklist.Table", {
      ...
      createContent : function(oController) {
    	  ...
    	  var oModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/poWorklist.xsodata/", true);
        ...
        var oButton2 = new sap.ui.commons.Button("btnZip",{
			text : oBundle.getText("zip"),
			tooltip : oBundle.getText("t_zip"),
			press : function(oEvent){
	          	  oController.onTBPress(oEvent,oController); } 
		});
