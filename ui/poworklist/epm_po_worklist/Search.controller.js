...
//   }
	...
	setFilter: function(terms, attribute)
	{
		...
		var oTableItem = sap.ui.getCore().byId("poItems");
	...
	loadFilter: function(oEvent)
	{
	    ...
	    var aUrl = '/sap/hana/democontent/epmNext/services/poWorklistQuery.xsjs?cmd=filter'+'&query='+escape(oEvent.getParameter("value"))+'&page=1&start=0&limit=25';
	    jQuery.ajax({
	       url: aUrl,
	       method: 'GET',
	       dataType: 'json',
