sap.ui.controller("sales_dashboard.Overview", {
	...
	onInit: function() {
        ...
        var oDiscountModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesDiscount.xsodata/");
        ...
        var oSalesRegionModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesByRegion.xsodata", true);
        ...
        var oSalesCountryModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesByCountry.xsodata/", true);
        ...
        var oSalesRankModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesSalesRank.xsodata/", true);
