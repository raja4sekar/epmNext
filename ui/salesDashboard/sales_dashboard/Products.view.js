sap.ui.jsview("sales_dashboard.Products", {
	...
	createContent : function(oController) {
	    ...
	    var oModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesYearCompare.xsodata/", true);
     ...
     layoutNew.createRow(oYearsCompareBarChart);  
	    ...
	    var oModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesByProduct.xsodata/", true);
