sap.ui.jsview("sales_dashboard.Details", {
	...
	createContent : function(oController) {
	  ...
	  oLayout.createRow(oSearchView);
  	  ...
  	  var oModel = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesOrders.xsodata/", true);
    ...
    //Sales Items
	var oModelItem = new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/salesOrders.xsodata/", true);
 	var arrayHeaders = new Array();
    var oControl;
...
createNewDialogContent: function(oController) {
	...
	this.oComboBoxBp.setModel(new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/businessPartners.xsodata", 
			true));
...
createNewLineItemContent: function(oController){
	...
	oComboBoxPd.setModel(new sap.ui.model.odata.ODataModel("/sap/hana/democontent/epmNext/services/productDetails.xsodata", 
			true));
