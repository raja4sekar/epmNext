...
sap.account.TileDialog.prototype.getHrefLocation = function(tileID) {
	switch (tileID) {
	case 1:
		return '/sap/hana/democontent/epmNext/admin/admin.html';
	case 2:
		return '/sap/hana/democontent/epmNext/ui/poworklist/poWorklist.html';
	case 3:
		return '/sap/hana/democontent/epmNext/ui/salesDashboard/index.html';
	case 4:
		return '/sap/hana/democontent/epmNext/ui/salesDashboard/soWorklist.html';
	case 5:
		return '/sap/hana/democontent/epmNext/ui/odataCRUD/index.html';
	case 6:
		return '/sap/hana/uis/clients/ushell-app/shells/hana/shell.html#appsite-display~ctx?siteID=sap%7Chana%7Cdemocontent%7CepmNext%7Cui%7Cuis%7Csite%7CUISExample';
	case 7:
		return '/sap/hana/uis/clients/desktop/applications/uis/runtime.html?siteID=sap%7Chana%7Cdemocontent%7CepmNext%7Cui%7Cuis%7Csite%7CUISExample#context/eyJjdHhSb3V0ZUlkIjoiMTM4MzA1MTUzODI3MiIsImNvbnRleHRNYXAiOnt9fQ==';
	case 8:
	    return '/sap/hana/democontent/epmNext/spatial/ui/index.html';
	case 9:
	    return '/sap/hana/democontent/epmNext/fulltextsearch/ui/search.html';
	case 10:
	    return '/sap/hana/democontent/epmNext/ui/salesDashMobile/index.html';
	case 11:
	    return '/sap/hana/uis/clients/ushell-app/shells/fiori/FioriLaunchpad.html?siteId=sap.hana.democontent.epmNext|ui|uis|FioriLaunchPad|FioriShineLaunchPad';
	}
}
...
//	var showWelcomeDialog = sap.app.localStorage.getPreference(sap.app.localStorage.PREF_DISPLAY_WELCOME_DIALOG);
	...
	var ok = function(oEvent) {
		sap.app.localStorage.storePreference(sap.app.localStorage.PREF_TILE_HELP_SHOW_PREFIX + tileID, 
		                                        !oNotShowAgainChkBox.getChecked());
		oTileDialog.close();
		setTimeout(function(){window.location = dialog.getHrefLocation(tileID);},1000);
	};
