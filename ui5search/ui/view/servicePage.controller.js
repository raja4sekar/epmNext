...
sap.ui.controller("sap.shine.esh.view.servicePage", {
    ...
    /*    handleNavBack: function() {
        sap.ui.getCore().byId("app--explorer").back();
    },*/
    ...
    fillTable: function() {
        ...
        var resultList = this.byId(settings.ID + "-resultList");
        var resultTable = this.byId(settings.ID + "-resultTable");
    ...
    fillSortBySelector: function(properties) {
        ...
        this.byId(settings.ID + "sortBySelector").addItem(startItem);
        ...
        for (var i = 0; i < properties.length; i++) {
            ...
            this.byId(settings.ID + "sortBySelector").addItem(item);
        }

        this.byId(settings.ID + "sortBySelector").setSelectedItem(startItem);
    },
    ...
    switchControls: function(evt) {
        ...
        var table = this.byId(settings.ID + "-resultTable");
        var facets = this.byId(settings.ID + "-facetList");
    ...
    //does not work yet
    //TODO: re-implement when mattias facet control is done
    filterByFacet: function() {
        ...
        var searchBar = this.byId(settings.ID + "searchBar");
        ...
        var filterList = [];
        var facetListItems = this.byId(settings.ID + "-facetList").getItems();
        ...
        //apply sort again after filtering
    ...
    handleSortChange: function() {
        ...
        var selectedButton = this.byId(settings.ID + "-ascDscSegButtons").getSelectedButton();
        ...
        var path = this.byId(settings.ID + "sortBySelector").getSelectedItem().getText();
