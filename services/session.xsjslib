...
var proc = XSProc.allProcedures("SAP_HANA_EPM_NEXT","sap.hana.democontent.epmNext.procedures");
...
function getSessionId(){
	...
	if(sessionId === null){
		...
		var pstmt;
		var rs;
		var query = 'select "sap.hana.democontent.epmNext.data::sessionId".NEXTVAL from dummy';
