         ...
         oController.bpMarkers.addListener(CLICK, function(evt) {
             ...
             if (marker instanceof nokia.maps.map.Marker) {
                 ...
                 $.ajax({
                     type: "GET",
                     async: true,
                     url: "/sap/hana/democontent/epmNext/spatial/services/getBPTransactionData.xsjs?cmd=getData&bpId=" + marker.data.partnerID,
             ...
             if (addedCoords.length == 1) {
                 ...
                 marker.addListener(CLICK, function(evt) {
                     ...
                     $.ajax({
                         ...
                         async: true,
                         url: "/sap/hana/democontent/epmNext/spatial/services/getSalesAnalysis.xsjs",
                         success: function(data) {
