sap.ui.controller("spatial-demo.bpDetails", {
    ...
    onAfterRendering: function() {
        ...
        $.ajax({
            type: "GET",
            async: false,
            url: "/sap/hana/democontent/epmNext/spatial/services/getAllBusinessPartnersData.xsjs",
        ...
        function onMarkerSelected(label, selectedBP, marker) {
            ...
            $.ajax({
                type: "GET",
                async: false,
                url: "/sap/hana/democontent/epmNext/spatial/services/getBPTransactionData.xsjs?cmd=getData&bpId=" + selectedBP.ID,
                success: function(data) {
                    var sales, purchase;
